...
Tuners: [GitHub Link](https://github.com/Pedro-Pathing/Docs/tree/master/public/docs/swerve)
...
and then will use AutoTune to tune their algorithm's constants. The tuners can be found [**here**](https://github.com/Pedro-Pathing/Docs/tree/master/public/docs/swerve).
...
To do this, run the [Analog Min / Max Tuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/AnalogMinMaxTuner.java) opmode. After you press start, slowly rotate each
...
Then, run the [SwerveOffsetsTuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/SwerveOffsetsTuner.java) opmode (do this off the ground, the servos and motors will spin). This opmode will attempt to drive each pod to its zero position. However, there are a few
...
If you have completed all of the above steps correctly, when running [SwerveOffsetsTuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/SwerveOffsetsTuner.java), the robot should drive forward slowly when you put it on the ground.
...
then, run the [SwerveTurnTuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/SwerveTurnTuner.java) opmode. Your pods should turn to be perpendicular to the center of the robot, forming
...
the motors are running the wrong direction, but they are all correct for the [SwerveOffsetsTuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/SwerveOffsetsTuner.java) to move your robot forward, then you almost certainly
...
## Pod PIDF Tuning
Finally, you need to tune your pod PIDF coefficients. Run the [SwervePIDTuner](https://github.com/Pedro-Pathing/Docs/blob/master/public/docs/swerve/SwervePIDTuner.java) opmode to tune your PIDs. You can do this using whatever method you prefer to tune your PIDFs. What I've found to work
...
There is also a [swerve constants reference page](/docs/pathing/tuning/drivetrain/swerve/swerve-constants-example) that you can use to see a fully setup swerve config. Finally, if you have any other questions, please feel free to reach out to me (@_kubar) on discord through the [Pedro discord server](https://discord.gg/YZHKPGzRXR).
(preferred) or DMs.
