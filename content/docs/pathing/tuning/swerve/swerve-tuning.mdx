...
If none of the above steps work to have the servos move to their zero positions, then you probably have an issue with wiring. Go through and make sure
that all of your servo, encoder, and motor ports are plugged in correctly.
